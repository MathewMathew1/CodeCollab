...
const TemporaryFolder = ({ stackLevel }) => {
    const [name, setName] = (0, react_1.useState)("");
    const { createFolderFunction } = (0, _id_1.useProject)();
    ...
    const handleKeyDown = (e) => {
        if (e.key === "Enter") {
            ...
            createFolderFunction(name, idOfParentFolder);
            closeAddingNewThing();
        }
    };
...
exports.default = TemporaryFolder;
